            ...
            <div id="layoutDefault_content">
                <main>
                    ...
                    <nav class="navbar navbar-marketing navbar-expand-lg bg-white  navbar-light">
                        <div class="container">
                            <a class="navbar-brand text-dark" href="index.php">Developer Lynda</a>
                            ...
                            <div class="container">
                                <div class="row justify-content-center">
                                    <div class="col-xl-8 col-lg-10 text-center">
                                        ...
                                        <h1 class="page-header-title">Welcome to Developer Lynda</h1>
                    ...
                    <section class="bg-white py-10">
                        ...
                        <hr />
                        <?php 
                            $sql4 = "SELECT * FROM posts WHERE post_status = :status ORDER BY post_view DESC LIMIT 0, 1";
                        ...
                        ?>
                            ...
                            <div class="row">
                                <?php 
                                    $sql2 = "SELECT * FROM posts WHERE post_status = :status ORDER BY post_view DESC LIMIT 0, 3";
