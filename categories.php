            ...
            <div id="layoutDefault_content">
                <main>
                    ...
                    <section class="bg-white py-10">
                        ...
                        <hr />
                            <?php 
                            $sql4 = "SELECT * FROM posts WHERE post_status = :status AND post_cat_id = :id ORDER BY post_view DESC LIMIT 0, 1";
                        ...
                        ?>
                            ...
                            <?php
                                $sql = "SELECT * FROM posts WHERE post_status = :status AND post_cat_id = :id";
                            ...
                            <div class="row">
                                <?php
                                    $sql = "SELECT * FROM posts WHERE post_status = :status AND post_cat_id = :id ORDER BY post_id DESC LIMIT $page_id, $post_per_page";
                                    $stmt = $pdo->prepare($sql);
                                    $stmt->execute([
                                        ':status' => 'Published',
                                        ':id' => $_GET['category_id']
