                ...
                <main>
                    ...
                    <?php
                        if(isset($_GET['post_id'])) {
                            ...
                            $post_category_id = $post['post_cat_id'];
                            ...
                            $sql1 = "UPDATE posts SET post_view = post_view + 1 WHERE post_id = :id";
                    ...
                    <section class="bg-white py-10">
                        <div class="container">
                            ...
                            <div class="pt-5 col-lg-8 col-xl-9">
                                ...
                                <hr class="mb-4" />
                                <?php 
                                    $sql = "SELECT * FROM comment WHERE com_post_id = :id";
                                    $stmt = $pdo->prepare($sql);
                                    $stmt->execute([
                                        ':id' => $_GET['post_id']
                                    ]);
                                    ...
                                    if($count == 0) {
                                        ...
                                        $sql1 = "SELECT * FROM comment WHERE com_post_id = :id";
                                            ...
                                            <div class="card-body">
                                                <?php 
                                                    if(isset($_POST['submit'])) {
                                                        ...
                                                        $sql = "INSERT INTO comment (com_post_id, com_detail, com_user_id, com_user_name) VALUES (:post_id, :com_detail, :user_id, :user_name)";
                                                        $stmt = $pdo->prepare($sql);
